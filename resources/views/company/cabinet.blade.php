                ...
                <div class="col-lg-8">
                    ...
                    <div class="card-footer text-muted" style="margin: 5px">
                        <button class="btn btn-success" style="color: white; "
                                onclick="window.location.href = '/add_object';">
                            Добавить объект
                        </button>
                    </div>
                        ...
                        <div class="card text-center" style="margin-top: 25px">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-outline-success btn-sm"
                                        onclick="window.location.href = '/view_category/obj_id{{$item['id']}}';">
                                    Изменить категории
                                </button>
                                <br>
                                ...
                                @endif
                                <button class="btn btn-outline-success btn-sm"
                                        onclick="window.location.href = '/view_wash/obj_id{{$item['id']}}';">
                                    Изменить виды
                                </button>
                                <br>
                                ...
                                <button class="btn btn-outline-success btn-sm"
                                        onclick="window.location.href = '/view_more/obj_id{{$item['id']}}';">
                                    Изменить доп
                                </button>
                                <br>
                                <button class="btn btn-outline-primary btn-sm"
                                        onclick="window.location.href = '/table_cost/obj_id{{$item['id']}}';">
                                    >>Таблица цен<<
                                </button>
                            </div>
                            ...
                            <div class="card-footer text-muted">
                                ...
                                <button class="btn btn-success btn-sm" style="color: white; "
                                        onclick="window.location.href = '/object/<?= $item ['id'];  ?>/update';">
                                    Редактировать
                                </button>
                                <a onClick="return confirm('Подтвердите удаление!')"
                                   href='/object/<?= $item['id'];  ?>/delete' type='button'
